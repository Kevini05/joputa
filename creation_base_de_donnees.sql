...
(
  id_abonne         int,
  id_exemplaire		int,	-- manque **
  date_retour       date, --yyyy-mm-dd
  constraint pk_retour primary key (id_exemplaire,date_retour),--id_abonne ne peut pas etre le cle primaire **
  foreign key (id_abonne) references abonne(id),
  foreign key (id_exemplaire) references exemplaire(id) -- manque **
);
...
-- emprunt
insert into emprunt values(1,1,'2018-10-10');              -- id = 1
insert into emprunt values(1,1,'2017-02-10');               -- id = 2
insert into emprunt values(2,3,'2018-02-10');     -- id = 3
insert into emprunt values(3,1,'2017-08-10');     -- id = 4
insert into emprunt values(3,1,'2018-09-26');             -- id = 5
insert into emprunt values(4,4,'2016-02-10');     -- id = 6
insert into emprunt values(4,4,'2018-10-15');             -- id = 7
insert into emprunt values(4,8,'2018-10-15');             -- id = 8